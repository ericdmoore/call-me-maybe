...
### M4 · Handsets texting handsets

The SIP MESSAGE context in `extensions.conf`; the WP826 messages app
configured by s10's template. Done when the theater texts the kitchen and
nothing touches the trunk or the bill.
